...
import { EmploymentStatus, PersonDetails } from '../../common/types';
import { PersonDetailsFormSchema } from '../../common/schemas';
...
const PersonalDetailsPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      />
      {formData.empStatus === EmploymentStatus.Employed && (
        <FormInput
          type="text"
          label="Employer Name"
          name="empName"
